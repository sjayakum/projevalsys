...
if(isset($_POST['usn1f']) && isset($_POST['usn2f']) && isset($_POST['usn3f'])  && isset($_POST['usn4f']) ){
	...
	if(!empty($usn1f) &&  !empty($usn2f) && !empty($usn3f) && !empty($usn4f) ){
		...
		$query = "UPDATE `test1` set crit12 ='$usn1f' where usn='$a[0]' ";
		if($query_run = mysql_query($query)){
		}

		$query = "UPDATE `test1` set crit12 ='$usn2f' where usn='$a[1]' ";
		if($query_run = mysql_query($query)){
		}

		$query = "UPDATE `test1` set crit12 ='$usn3f' where usn='$a[2]' ";
		if($query_run = mysql_query($query)){
		}

		$query = "UPDATE `test1` set crit12 ='$usn4f' where usn='$a[3]' ";
		if($query_run = mysql_query($query)){
		}
...
<body style="background-color:#031626">
	<?php if (login_check() == true) : ?>
		<div class="container">
			<div class="col-md-12">
				<h1 align="center" style="color:lightgray;"><br/> TECHNICAL PAPER ON PROJECT WORK (3 MARKS) (CO 2, 7)<br/></h1><br/>
		...
		<br/>
		<form method="POST" action="Rubric12.php">
			<div class="[ container text-center ]">
				...
				<br/><br/>
					...
					<ul class="pagination pagination-lg" >
						...
						<li class="active"><a href="Rubric12.php">12</a></li>
