...
if(isset($_POST['usn1f']) && isset($_POST['usn2f']) && isset($_POST['usn3f'])  && isset($_POST['usn4f']) ){
	...
	if(!empty($usn1f) &&  !empty($usn2f) && !empty($usn3f)  ){
		...
		$query = "UPDATE `test1` set crit2 ='$usn1f' where usn='$a[0]' ";
		if($query_run = mysql_query($query)){
		}


		$query = "UPDATE `test1` set crit2 ='$usn2f' where usn='$a[1]' ";
		if($query_run = mysql_query($query)){
		}
		...
		$query = "UPDATE `test1` set crit2 ='$usn3f' where usn='$a[2]' ";
		if($query_run = mysql_query($query)){
		}



		$query = "UPDATE `test1` set crit2 ='$usn4f' where usn='$a[3]' ";
		if($query_run = mysql_query($query)){
		}
  ...
  <!--[if lt IE 9]>
   ...
   <body style="background-color:#031626">
   	<?php if (login_check() == true) : ?>
   		<div class="container">
   			<div class="col-md-12">
   				<h1 align="center" style="color:lightgray;"> RUBRIC 2 </h1>
   				<div style="font-size:18px">
   					<table class="table-striped" align="center" cellpadding="20">
   						<tr align="center">
   							<td><b>Criteria Two: Design</b></td>
   							<td><b>Marks</b></td>
   						</tr>

   						<tr align="center" style="color:lightgray">
   							<td> Clearly addressed the design issues </td>
   							<td> 9-10 </td>
   						</tr>

   						<tr align="center">
   							<td> Addressed the design issues </td>
   							<td> 7-8 </td>
   						</tr>

   						<tr align="center" style="color:lightgray">
   							<td> Considered the design issues </td>
   							<td> 5-6 </td>
   						</tr>

   						<tr align="center">
   							<td> Not addressed design issues </td>
   							<td> 3-4 </td>
   						</tr>

   						<tr align="center" style="color:lightgray"> 
   							<td> Unclear about the design </td>
   							<td> 1-2 </td>
   						</tr>

   					</table>

   					<form method="POST" action="Rubric2.php">
   									...
   									<div class="[ row ]">
   										<div class="col-md-12">
   											<ul class="pagination pagination-lg" align="center">
   												<li><a href="Rubric1.php">&laquo;</a></li>
   												<li><a href="FirstTable.php"> Main Table</a></li>
   												<li><a href="Rubric1.php">1</a></li>
   												<li class="active"><a href="Rubric2.php">2</a></li>
   												...
   												<li><a href="Rubric3.php">&raquo;</a></li>
   											</ul>	
   										</div>
   									</div>
   								</div>
