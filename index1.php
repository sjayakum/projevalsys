        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a style="-webkit-transition: all .3s; -moz-transition: all .3s; transition: all .3s;" class="page-scroll portfolio-link" href="#LoginPage" data-toggle="modal" bounceIn>Sign In</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
