...
if(isset($_POST['usn1f']) && isset($_POST['usn2f']) && isset($_POST['usn3f'])  && isset($_POST['usn4f']) ){
	...
	if(!empty($usn1f) &&  !empty($usn2f) && !empty($usn3f) ){
		...
		if(empty($usn4f)){
			...
			$query = "UPDATE `test1` set crit9 ='$usn1f' where usn='$a[0]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit9 ='$usn2f' where usn='$a[1]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit9 ='$usn3f' where usn='$a[2]' ";
			if($query_run = mysql_query($query)){
			}
         ...
         $query = "UPDATE `test1` set crit9 ='$usn4f' where usn='$a[3]' ";
         if($query_run = mysql_query($query)){
         }
         echo "
         <script type='text/javascript'>
          ...
          <div class="col-md-9 col-md-offset-1">
            ...
            <div style="font-size:18px">
              <table class="table-striped" align="center" cellpadding="20">
                <tr align="center">
                  <td><b>Criteria 9: Written Communication (Report)</b></td>
                  <td><b>Marks</b></td>
               </tr>

               <tr align="center" style="color:lightgray">
                  <td> Clear and Effective writing and adherence to appropriate style guidelines </td>
                  <td> 5 </td>

               </tr>

               <tr align="center">
                  <td> Writing that is clear and effective for the most part and adherence to appropriate style guidelines </td>
                  <td> 4 </td>
               </tr>

               <tr align="center" style="color:lightgray">
                  <td> Writing that is clear and effective for the most part and minor errors in adherence to appropriate style guidelines </td>
                  <td> 3 </td>
               </tr>

               <tr align="center">
                  <td> Unclear and ineffective writing and no attention to appropriate style guidelines </td>
                  <td> 2 </td>
               </tr>
            ...
            <br/><br/>
            <form method="POST" action="Rubric9.php">
