...
if(isset($_POST['usn1f']) && isset($_POST['usn2f']) && isset($_POST['usn3f'])  && isset($_POST['usn4f']) ){
	...
	if(!empty($usn1f) &&  !empty($usn2f) && !empty($usn3f) ){
		...
		if(empty($usn4f)){
			...
			$query = "UPDATE `test1` set crit8 ='$usn1f' where usn='$a[0]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit8 ='$usn2f' where usn='$a[1]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit8 ='$usn3f' where usn='$a[2]' ";
			if($query_run = mysql_query($query)){
			}
			...
			$query = "UPDATE `test1` set crit8 ='$usn4f' where usn='$a[3]' ";
			if($query_run = mysql_query($query)){
			}
			echo "
			<script type='text/javascript'>
   			...
   			<div class="col-md-12">
   				...
   				<div style="font-size:18px">
   					<table class="table-striped" align="center" cellpadding="20">
   						<tr align="center">
   							<td><b>Criteria 8: Societal Issues</b></td>
   							<td><b>Marks</b></td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Clearly address societal issues</td>
   							<td>4</td>
   						</tr>
   						<tr align="center">
   							<td>Addressed the societal issues</td>
   							<td>3</td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Able the show the societal issues</td>
   							<td>2</td>
   						</tr>
   						<tr align="center">
   							<td>Not clearly address the societal issues</td>
   							<td>1</td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Not addressed societal issues</td>
   							<td>0</td>
   						</tr>
   					</table>
   					<br/><br/>
   					<form method="POST" action="Rubric8.php">
   								...
   								<div class="[ col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 ]" role="tabpanel">
   									<div class="[ col-xs-4 col-sm-12 ]">
   										<table class="table" align="center" cellpadding="20">
   											...
   											<tr>
   												<td> <input type="text" class="form-control"  id="usn1" maxlength="10" readonly="readonly" value="<?php echo $a[0] ?>" /></td>
   												<td> 
