...
if(isset($_POST['usn1f']) && isset($_POST['usn2f']) && isset($_POST['usn3f'])  && isset($_POST['usn4f']) ){
	...
	if(!empty($usn1f) &&  !empty($usn2f) && !empty($usn3f)){
		...
		if(empty($usn4f)){
			...
			$query = "UPDATE `test1` set crit7 ='$usn2f' where usn='$a[0]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit7 ='$usn2f' where usn='$a[1]' ";
			if($query_run = mysql_query($query)){
			}

			$query = "UPDATE `test1` set crit7 ='$usn3f' where usn='$a[2]' ";
			if($query_run = mysql_query($query)){
			}
			...
			$query = "UPDATE `test1` set crit7 ='$usn1f' where usn='$a[0]' ";
			if($query_run = mysql_query($query)){
			}
			...
			$query = "UPDATE `test1` set crit7 ='$usn4f' where usn='$a[3]' ";
			if($query_run = mysql_query($query)){
			}
   			...
   			<div class="col-md-12">
   				...
   				<div style="font-size:18px">
   					<table class="table-striped" align="center" cellpadding="20">
   						<tr align="center">
   							<td><b>Criteria 7: Plan of work</b></td>
   							<td><b>Marks</b></td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Clearly summarized the plan of work</td>
   							<td>4</td>
   						</tr>
   						<tr align="center">
   							<td>Summarized the plan of work</td>
   							<td>3</td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Manage to summarize the plan of work</td>
   							<td>2</td>
   						</tr>
   						<tr align="center">
   							<td>Not clear to summarize the plan of work</td>
   							<td>1</td>
   						</tr>
   						<tr align="center" style="color:lightgray">
   							<td>Not summarized the plan of work</td>
   							<td>0</td>
   						</tr>

   					</table>
   					<br/><br/>
   					<form method="POST" action="Rubric7.php">
   									...
   									<div class="[ row ]">
   										<div class="col-md-12">
   											<ul class="pagination pagination-lg" align="center">
   												<li><a href="Rubric6.php">&laquo;</a></li>
   												...
   												<li class="active"><a href="Rubric7.php">7</a></li>
   												...
   												<li><a href="Rubric8.php">&raquo;</a></li>
   											</ul>	
   										</div>
   									</div>
   								</div>
